...
cd BMS
python eval.py --dir ./logs/eval/baseline --base_dataset ImageNet_test --base_split datasets/split_seed_1/miniImageNet_test_labeled_80.csv --embedding_load_path ./logs/baseline/EuroSAT/checkpoint_best.pkl
python eval.py --dir ./logs/eval/BMS_Euro --base_dataset ImageNet_test --base_split datasets/split_seed_1/miniImageNet_test_labeled_80.csv --embedding_load_path ./logs/vanilla/EuroSAT/checkpoint_best.pkl
