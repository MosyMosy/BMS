...
cd BMS
python main2.py --dir ./logs2/ISIC --target_dataset ISIC --target_subset_split datasets/split_seed_1/ISIC_unlabeled_20.csv --bsize 256 --epochs 1000 --model resnet10
