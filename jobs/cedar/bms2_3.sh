...
cd BMS
python main2.py --dir ./logs2/CropDisease --target_dataset CropDisease --target_subset_split datasets/split_seed_1/CropDisease_unlabeled_20.csv --bsize 128 --epochs 1000 --model resnet10
