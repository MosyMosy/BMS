...
python BAS_in.py --dir ./logs/BAS_in/$target_testset --target_dataset $target_testset --target_subset_split datasets/split_seed_1/$target_testset\_unlabeled_20.csv --bsize 128 --epochs 1000 --model resnet10
...
date +"%T"
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/BMS/logs/BAS_in/$target_testset/ ~/scratch/BMS/logs/BAS_in/
