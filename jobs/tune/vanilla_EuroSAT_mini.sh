...
#SBATCH --job-name=vanilla_EuroSAT_mini_tune
...
cd BMS
python finetune.py --save_dir ./logs/vanilla/EuroSAT_mini --target_dataset miniImageNet_test --embedding_load_path ./logs/vanilla/EuroSAT/checkpoint_best.pkl --freeze_backbone &
...
date +"%T"
cd $SLURM_TMPDIR
cp -r $SLURM_TMPDIR/BMS/logs/vanilla/ ~/scratch/BMS/logs/
