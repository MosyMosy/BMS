...
#SBATCH --job-name=baseline_mini_mini_tune
...
cd BMS
python finetune.py --save_dir ./logs/baseline/mini_mini --target_dataset miniImageNet_test --embedding_load_path ./logs/baseline/EuroSAT/checkpoint_best.pkl --freeze_backbone
