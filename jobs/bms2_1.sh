...
cd BMS
python main2.py --dir ./logs2/EuroSAT --target_dataset EuroSAT --target_subset_split datasets/split_seed_1/EuroSAT_unlabeled_20.csv --bsize 256 --epochs 1000 --model resnet10
