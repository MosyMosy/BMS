...
cd BMS
python main.py --dir ./logs/ChestX --target_dataset ChestX --target_subset_split datasets/split_seed_1/ChestX_unlabeled_20.csv --bsize 128 --epochs 1000 --model resnet10
